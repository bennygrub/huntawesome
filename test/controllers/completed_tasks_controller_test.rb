...
class CompletedTasksControllerTest < ActionController::TestCase
  ...
  test "should create completed_task" do
    assert_difference('CompletedTask.count') do
      post :create, completed_task: { group_id: @completed_task.group_id, task_id: @completed_task.task_id, user_id: @completed_task.user_id }
    end
  ...
  test "should update completed_task" do
    patch :update, id: @completed_task, completed_task: { group_id: @completed_task.group_id, task_id: @completed_task.task_id, user_id: @completed_task.user_id }
    assert_redirected_to completed_task_path(assigns(:completed_task))
  end
