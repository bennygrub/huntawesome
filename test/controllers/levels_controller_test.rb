...
class LevelsControllerTest < ActionController::TestCase
  ...
  test "should create level" do
    assert_difference('Level.count') do
      post :create, level: { description: @level.description, name: @level.name, pillar: @level.pillar, points: @level.points }
    end
  ...
  test "should update level" do
    patch :update, id: @level, level: { description: @level.description, name: @level.name, pillar: @level.pillar, points: @level.points }
    assert_redirected_to level_path(assigns(:level))
  end
